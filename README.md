# BrightGreen — Datamodeling Fundamentals (finished result)

This branch is the **finished result** of the [Datamodeling Fundamentals](https://www.crossmodel.io/knowledgebase/tutorials/datamodeling-fundamentals/) tutorial.
...
## Follow the tutorial
  ...
  **https://www.crossmodel.io/knowledgebase/tutorials/datamodeling-fundamentals/**
...
A `MyFirstModel` data model containing the `Customer`, `Product`, `SalesOrder` and
`SalesOrderLine` entities and the three relationships between them — everything the tutorial
asks you to build.
