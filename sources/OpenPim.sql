...
COPY public.actions (identifier, name, code, triggers, id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt", "order") FROM stdin;
\.
...
COPY public.channels (identifier, name, active, type, valid, visible, config, mappings, runtime, id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt", "order", "parentId", "group") FROM stdin;
\.
...
COPY public."collectionItems" (id, "itemId", "collectionId", "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public.collections (id, identifier, name, public, "user", "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
COPY public."importConfigs" (id, identifier, name, type, mappings, filedata, config, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
COPY public.processes (id, identifier, title, active, status, "finishTime", "storagePath", "mimeType", "fileName", log, runtime, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
admin	Administrator	{"lovs": 2, "roles": 2, "types": 2, "users": 2, "actions": 2, "channels": 2, "languages": 2, "relations": 2, "templates": 2, "attributes": 2, "dashboards": 2, "importConfigs": 2}	{"access": 0, "groups": [], "relations": []}	{"valid": [], "access": 0, "groups": [], "fromItems": []}	{"audit": true, "search": true, "imports": 2, "exportCSV": true, "exportXLS": true, "importXLS": true, "searchRelations": true, "exportRelationsXLS": true, "importRelationsXLS": true}	1	default	system	system	2020-09-16 14:23:32.909034+03	2020-09-16 14:23:32.909034+03	\N	[]	[]
user	User	{"lovs": 0, "roles": 0, "types": 0, "users": 0, "actions": 0, "channels": 0, "languages": 0, "relations": 0, "templates": 0, "attributes": 0, "dashboards": 0, "importConfigs": 0}	{"access": 0, "groups": [], "relations": []}	{"valid": [], "access": 0, "groups": [], "fromItems": []}	{"audit": false, "search": true, "imports": 0, "exportCSV": true, "exportXLS": true, "importXLS": false}	2	default	system	admin	2020-09-16 14:23:32.909034+03	2025-01-05 17:08:50.818+03	\N	[]	[]
\.
...
COPY public."savedSearch" (identifier, name, public, extended, filters, "whereClause", "user", id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt", entity) FROM stdin;
\.
...
COPY public.templates (id, identifier, name, template, "order", valid, visible, options, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
--
-- Name: templates templates_identifier_tenantId_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.templates
    ADD CONSTRAINT "templates_identifier_tenantId_key" UNIQUE (identifier, "tenantId");
